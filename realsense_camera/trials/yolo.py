...
model_human   = YOLO(os.path.join(MODELS_DIR, "yolov8n.pt"))  # COCO pretrained — for person detection
model_unitree = YOLO(os.path.join(MODELS_DIR, "best.pt"))     # custom-trained on Unitree Go1 robot
